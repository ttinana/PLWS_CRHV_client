		...
		for (PrivredniSubjekat ps : listOfPS.getPrivredniSubjekat()) {
			...
			for (Grupa grupa : ps.getGrupa()) {
				...
				try {
					...
					logger.debug(" |DEBUG| Insert into from  Promene. ");
				} catch (Exception e) {
	...
	public void insertListAll(ArrayOfPrivredniSubjekat listOfPS, JdbcTemplate jdbcTemplate) {
		...
		for (PrivredniSubjekat ps : listOfPS.getPrivredniSubjekat()) {
			...
			for (Grupa grupa : ps.getGrupa()) {
				...
				/********************************* 1007 ******************************************/
				/* na mysql-u nisam kreirala tabele pa komentaisem kod za nekreirane...*/
				...
				/*if (myGrupa == 1007) {
					...
					String sql = "insert into  Grupa_1007t (IdentifikatorGrupe, MaticniBroj, Naziv, NazivLatinica ) VALUES (?, ?, ?, ?)";
				...
				/*if (myGrupa == 102) {
					...
					String sql = "insert into  Grupa_102t (IdentifikatorGrupe, MaticniBroj, PunNaziv, PunNazivLatinica ) VALUES (?, ?, ?, ?)";
					jdbcTemplate.update(sql, new Object[] { myGrupa, mb, PunNaziv, PunNazivLatinica },
							new int[] { Types.INTEGER, Types.NVARCHAR, Types.NVARCHAR, Types.NVARCHAR });
				}
				logger.debug(" |DEBUG| Klasa EntitySOAPeDAOeImpl. Insert into  Grupa_102. ");*/
				...
				/*if (myGrupa == 1045) {
					...
					String sql = "insert into  Grupa_1045t (IdentifikatorGrupe, MaticniBroj, PoslovnoIme, PoslovnoImeLatinica ) VALUES (?, ?, ?, ?)";
					jdbcTemplate.update(sql, new Object[] { myGrupa, mb, PoslovnoIme, PoslovnoImeLatinica },
							new int[] { Types.INTEGER, Types.NVARCHAR, Types.NVARCHAR, Types.NVARCHAR });
				}
				logger.debug(" |DEBUG| Klasa EntitySOAPeDAOeImpl. Insert into  Grupa_1045. ");*/
				/********************************** 1046 ****************************************************/
				/*if (myGrupa == 1046) {
					String skracenoPoslovnoIme = "";
					String skracenoPoslovnoImeLatinica = "";
					...
					String sql = "insert into  Grupa_1046t (IdentifikatorGrupe, MaticniBroj, SkracenoPoslovnoIme, SkracenoPoslovnoImeLatinica ) VALUES (?, ?, ?, ?)";
					jdbcTemplate.update(sql,
							new Object[] { myGrupa, mb, skracenoPoslovnoIme, skracenoPoslovnoImeLatinica },
							new int[] { Types.INTEGER, Types.NVARCHAR, Types.NVARCHAR, Types.NVARCHAR });
				}*/
				...
				/*if (myGrupa == 49) {
					...
					for (Podatak podatak : grupa.getPodatak()) {
						...
						String sql = "insert into  Grupa_49t (IdentifikatorGrupe, MaticniBroj, Naziv) VALUES (?, ?, ?)";
				...
				/*if (myGrupa == 50) {
					...
					for (Podatak podatak : grupa.getPodatak()) {
						...
						String sql = "insert into  Grupa_50t (IdentifikatorGrupe, MaticniBroj, SkracenoPoslovnoIme) VALUES (?, ?, ?)";
				...
				/**********************************    ****************************************************/
				/*if (myGrupa == 55) {
					String sql = "insert into  Grupa_55t (IdentifikatorGrupe, MaticniBroj) VALUES (?, ?)";
					jdbcTemplate.update(sql, new Object[] { myGrupa, ps.getMaticniBroj() },
							new int[] { Types.INTEGER, Types.NVARCHAR });
				}*/
				/**********************************    ****************************************************/
/*
				if (myGrupa == 56) {
					...
					for (Podatak podatak : grupa.getPodatak()) {
						...
						String sql = "insert into  Grupa_56t (IdentifikatorGrupe, MaticniBroj, PIB) VALUES (?, ?, ?)";
						jdbcTemplate.update(sql, new Object[] { myGrupa, mb, PIB },
								new int[] { Types.INTEGER, Types.NVARCHAR, Types.NVARCHAR });

					}
					logger.debug(" |DEBUG| Klasa EntitySOAPeDAOeImpl. Insert into  Grupa_56. ");
				}*/
				/**********************************    ****************************************************/
	 ...
	 * "insert into  Grupa_108t (IdentifikatorGrupe, MaticniBroj) VALUES (?, ?)"
	 * ; jdbcTemplate.update(sql, new Object[] { myGrupa, mb }, new int[] {
	 * Types.INTEGER, Types.NVARCHAR }); logger.debug(
	 * " |DEBUG| Klasa EntitySOAPeDAOeImpl. Insert into  Grupa_108. "); }
	 * 
	 * } } logger.debug(
	 * " |DEBUG| Klasa EntitySOAPeDAOeImpl. Insert into  Grupa_1001. "); }
	 */
	...
	public void insertListAll2(ArrayOfPrivredniSubjekat listOfPS, JdbcTemplate jdbcTemplate) {
		...
		for (PrivredniSubjekat ps : listOfPS.getPrivredniSubjekat()) {
			...
			for (Grupa grupa : ps.getGrupa()) {
				...
				if (myGrupa == 1077) {
					...
					String sql = "insert into  Grupa_1077 (IdentifikatorGrupe, MaticniBroj, PIB) VALUES (?, ?, ?)";
					jdbcTemplate.update(sql, new Object[] { myGrupa, mb, pib },
							new int[] { Types.INTEGER, Types.NVARCHAR, Types.NVARCHAR });
				}
				/********************** 1078 *****************************************/
		...
		logger.debug(" |DEBUG| Klasa EntitySOAPeDAOeImpl. Insert into  Grupa_1001. ");
	}
}
